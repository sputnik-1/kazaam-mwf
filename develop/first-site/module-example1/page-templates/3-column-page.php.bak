...
<?php require "$MODULE_CONFIG/module-example1.conf.php"; ?>
...
<div id="left_column">
  <?php require "$MODULE_PATH/module-example1-menu.php" ?>
</div>

<div id="right_column">
  <?php require "$MODULE_PATH/module-example1-right-menu.php" ?>
</div>
