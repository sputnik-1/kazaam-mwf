...
<?php require "$MODULE_CONFIG/module-example3.conf.php"; ?>
...
<div class="box2">
<h3>3 Column page template with integrated page contents</h3>
</div>
...
<div id="left_column">
  <?php require "$MODULE_PATH/module-example3-menu.php" ?>
</div>

<div id="right_column">
  <?php require "$MODULE_PATH/module-example3-right-menu.php" ?>
</div>
