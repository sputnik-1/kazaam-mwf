<!-- main content of page goes here without the body tags! -->

<div class="box2">
<h3>New Ext Module - 2 Column page template with external &lt;body&gt; content.</h3>
</div>

<div class="box2">

<p>The contents of this page is external and included by PHP into
the Kazaam page framework.</p>

<p>This enable you to integrate existing html pages into Kazaam,
