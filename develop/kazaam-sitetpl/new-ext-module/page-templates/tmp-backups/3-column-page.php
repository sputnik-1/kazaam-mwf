...
<?php $MODULE_NAME = "$sitename - New Ext Module - 3 Column page template"; ?>
...
<div class="box2">
<h3>New Ext Module - 3 Column page template with integrated page contents</h3>
</div>
...
<div id="left_column">
  <?php require "$MODULE_PATH/new-ext-module-menu.php" ?>
</div>

<div id="right_column">
  <?php require "$MODULE_PATH/new-ext-module-right-menu.php" ?>
</div>
