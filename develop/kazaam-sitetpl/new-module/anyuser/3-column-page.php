...
<?php $MODULE_NAME = "$sitename - New Module - 3 Column page template"; ?>
...
<div class="box2">
<h3>New Module - 3 Column page template with integrated page contents</h3>
</div>
...
<div id="left_column">
  <?php require "$MODULE_PATH/new-module-menu.php" ?>
</div>

<div id="right_column">
  <?php require "$MODULE_PATH/new-module-right-menu.php" ?>
</div>
