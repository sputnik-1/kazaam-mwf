...
<?php $MODULE_NAME = "$sitename - sports-cars - 3 Column page template"; ?>
...
<div class="box2">
<h3>sports-cars - 3 Column page template with integrated page contents</h3>
</div>
...
<div id="right_column">
  <?php require "$MODULE_PATH/sports-cars-right-menu.php" ?>
</div>
